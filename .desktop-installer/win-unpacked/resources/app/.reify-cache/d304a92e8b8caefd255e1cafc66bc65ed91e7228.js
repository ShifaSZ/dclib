"use strict";module.export({default:()=>StorageMigration});var app;module.watch(require('electron'),{app(v){app=v}},0);var path;module.watch(require('path'),{default(v){path=v}},1);var findNewestFileOrDirectory,removePaths,rimrafPromisfied,ioOperationWithRetries,batchIoOperationWithRetries;module.watch(require('./storageMigration/ioHelper'),{findNewestFileOrDirectory(v){findNewestFileOrDirectory=v},removePaths(v){removePaths=v},rimrafPromisfied(v){rimrafPromisfied=v},ioOperationWithRetries(v){ioOperationWithRetries=v},batchIoOperationWithRetries(v){batchIoOperationWithRetries=v}},2);

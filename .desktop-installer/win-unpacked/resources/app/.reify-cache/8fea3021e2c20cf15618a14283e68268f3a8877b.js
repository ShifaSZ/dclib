"use strict";module.export({findNewestFileOrDirectory:()=>findNewestFileOrDirectory,rimrafPromisfied:()=>rimrafPromisfied,removePaths:()=>removePaths,ioOperationWithRetries:()=>ioOperationWithRetries,batchIoOperationWithRetries:()=>batchIoOperationWithRetries});var fs;module.watch(require('fs-plus'),{default(v){fs=v}},0);var shelljs;module.watch(require('shelljs'),{default(v){shelljs=v}},1);var rimraf;module.watch(require('rimraf'),{default(v){rimraf=v}},2);var fsExtra;module.watch(require('fs-extra'),{default(v){fsExtra=v}},3);
